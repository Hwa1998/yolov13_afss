...
def build_dataloader(dataset, batch, workers, shuffle=True, rank=-1, batch_sampler=None):
    ...
    Args:
        ...
        batch_sampler: Optional custom BatchSampler (e.g. AFSSBatchSampler).
            When provided, overrides shuffle and batch arguments.
    """
    ...
    if batch_sampler is not None:
        # Use custom batch sampler (e.g. AFSS) - no shuffle, no separate sampler
